...
CREATE TABLE `planes` (
  ...
  `max_luggage_weight` FLOAT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `airports` (`id`,`country`,`city`,`name`) VALUES 
(1,'USA','New York',NULL),
(2,'USA','New York','airport2'),
(3,'USA','Washington DC',NULL),
(4,'USA','Texas',NULL),
(5,'USA','Chicago',NULL),
(6,'USA','Miami',NULL),
(7,'Germany','Berlin','airport7'),
(8,'Germany','Berlin',NULL),
(9,'England','London',NULL),
(10,'Ukraine','Kyiv',NULL);
...
INSERT INTO `planes` (`id`,`airline_id`,`max_passengers`,`max_luggage_weight`) VALUES 
(1,1,100,NULL),
(2,1,150,NULL),
(3,1,200,30),
(4,1,200,NULL),
...
INSERT INTO `flights` (`id`,`src_airport_id`,`dest_airport_id`,`plane_id`,`departure_time`,`landing_time`) VALUES 
(1,1,2,1,'2022-09-13 17:00:00','2022-09-14 03:00:00'),
(2,1,3,2,'2022-09-13 18:00:00','2022-09-14 02:00:00'),
(3,1,4,3,'2022-09-13 19:00:00','2022-09-14 04:00:00'),
(4,1,6,4,'2022-09-13 20:00:00','2022-09-14 05:00:00'),
(5,1,7,5,'2022-09-13 21:00:00','2022-09-14 03:30:00'),
(6,2,1,6,'2022-09-13 17:00:00','2022-09-14 03:00:00'),
(7,2,8,5,'2022-09-13 19:00:00','2022-09-14 04:00:00'),
(8,2,9,4,'2022-09-13 15:00:00','2022-09-14 05:00:00'),
(9,3,8,3,'2022-09-13 17:00:00','2022-09-14 03:00:00'),
(10,4,10,1,'2022-09-13 17:00:00','2022-09-14 03:00:00');
